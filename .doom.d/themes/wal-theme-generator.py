...
def terminal_sexy_to_template(colors):
    ...
    if Color(colors["special"]["foreground"]).hls[1] > 0.5:
    ...
    new_colors = {
        "bg": background,
        "bg-alt": bg_fg_function(background, 0.1),
        "fg": foreground,
        "fg-alt": bg_fg_function(foreground, 0.2),
        "base8": bases_function(foreground, 0.1),
        "base7": bases_function(foreground, 0.2),
        "base6": bases_function(foreground, 0.3),
        "base5": bases_function(foreground, 0.4),
        "base4": bases_function(foreground, 0.5),
        "base3": bases_function(foreground, 0.6),
        "base2": bases_function(foreground, 0.7),
        "base1": bases_function(foreground, 0.8),
        "base0": bases_function(foreground, 0.9),
        "red": red,
        "orange": orange,
        "green": green,
        "teal": teal,
